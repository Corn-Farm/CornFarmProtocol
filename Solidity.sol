/**
 *Submitted for verification at hecoinfo.com on 2021-04-12
*/
...
contract CornToken is ERC20, Ownable {
    using SafeMath for uint256;
    bool public farmOnce = false;

    function initialize() public initializer {
        Ownable.__Ownable_init();
        ERC20.__ERC20_init("Corn Token", "CORN");

        // 400K for initial liquidity provider, 3.6M for the liquidity farm.
        _mint(msg.sender, 400000 * 1e18);
    }

    function distributeReward(address _farmPool) external onlyOwner {
        require(!farmOnce, "only can distribute farm once");
        require(_farmPool != address(0), "!_farmPool");
        farmOnce = true;
        _mint(_farmPool, (4000000-400000) * 1e18);
    }
